...
public class Case14 {
	...
	void test06() {
		examItLiteracy1Page.selectAnswer();
		examItLiteracy1Page.clickGoToConfirmBtn();
		
		assertThat(examItLiteracy1Page.getH2Text()).contains(Constants.TRUE_H2_EXAM_IT_LITERACY_1_CONFIRM_HALF);
	...
	void test07() throws InterruptedException {
		...
		assertThat(examItLiteracy1Page.getH2Text()).contains(Constants.TRUE_H2_EXAM_IT_LITERACY_1_RESULT_HALF);
