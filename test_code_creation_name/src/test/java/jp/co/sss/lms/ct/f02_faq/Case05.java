...
public class Case05 {
	...
	void test05() {
		faqPage.searchBy(Constants.KEYWORD_FAQ);
		
		assertEquals(Constants.TRUE_SEARCH_RESULT_COUNT, faqPage.countTr());
		assertEquals(Constants.TRUE_SEARCH_RESULT_TITLE, faqPage.getDt());
	...
	void test06() {
		...
		assertTrue(faqPage.getTextBox().isEmpty());
